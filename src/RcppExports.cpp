...
RcppExport SEXP _fast_lasso_rcppeigen_hello_world() {
BEGIN_RCPP
...
RcppExport SEXP _fast_lasso_rcppeigen_outerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _fast_lasso_rcppeigen_innerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type x(xSEXP);
...
RcppExport SEXP _fast_lasso_rcppeigen_bothproducts(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type x(xSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_fast_lasso_rcppeigen_hello_world", (DL_FUNC) &_fast_lasso_rcppeigen_hello_world, 0},
    {"_fast_lasso_rcppeigen_outerproduct", (DL_FUNC) &_fast_lasso_rcppeigen_outerproduct, 1},
    {"_fast_lasso_rcppeigen_innerproduct", (DL_FUNC) &_fast_lasso_rcppeigen_innerproduct, 1},
    {"_fast_lasso_rcppeigen_bothproducts", (DL_FUNC) &_fast_lasso_rcppeigen_bothproducts, 1},
